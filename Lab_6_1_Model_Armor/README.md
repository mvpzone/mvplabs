...
3. Click "Sign In" opn the top right, and sign in to your threatspace student account provided by your workshop administrator. 
4. File -> Open Notebook -> github -> mvpzone/mvplabs/Lab_6_1_Model_Armor/Lab_6_1_Threatspace_Prompt_Injection_and_Guardails_Model_Armor_Lab.ipynb
5. Open the `Lab 6.1 - Threatspace- Prompt Injection and Guardrails - Model Armor -Lab.ipynb` file in a incognito browser 
6. Follow the step-by-step instructions provided in the notebook.
